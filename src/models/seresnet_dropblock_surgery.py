...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        if input_3x3:
            ...
            ### SURGERY
            layer0_modules = [
                ('new_conv1' , nn.Conv2d(3, self.inplanes, kernel_size=5, stride=1, padding=2, bias=False)),
                ('new_bn1' , nn.BatchNorm2d(self.inplanes)),
                ('new_relu1' , nn.ReLU(inplace=True)),
                ('new_conv2' , nn.Conv2d(self.inplanes, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)),
                ('new_bn2' , nn.BatchNorm2d(self.inplanes)),
                ('new_relu2' , nn.ReLU(inplace=True)),
                ('new_conv3' , nn.Conv2d(self.inplanes, self.inplanes, kernel_size=3, stride=1, padding=1, bias=False)),
                ('new_bn3' , nn.BatchNorm2d(self.inplanes)),
                ('new_relu3' , nn.ReLU(inplace=True)),
            ]
